...
Public Class FrmD8_Dry
    ...
    Private Sub CurrentData()
        ...
        Sql = ("select value from[current] where [name] Like 'D8.Dry.inside_casing_wet_flt'")
        Sql1 = ("select value from[current] where [name] like 'D8.Dry.z1a_temp_f_pv'")
        sql2 = ("select value from[current] where [name] like 'D8.Dry.z1b_temp_f_pv'")
        Sql3 = ("select value from[current] where [name] like 'D8.Dry.z1c_temp_f_pv'")
        Sql4 = ("select value from[current] where [name] like 'D8.Dry.z3a_hum_%_pv'")
        sql5 = ("select value from[current] where [name] like 'D8.Dry.z1a_enable_di'") ' ok for d unit
        sql7 = ("select value from[current] where [name] like 'D8.Dry.Line_fpm_pv'")
        'sql8 = ("select value from[current] where [name] like 'D8.Dry.casing_temp7_f_pv'")
        sql9 = ("select value from[current] where [name] like 'D8.Dry.z1a1_blw_di'")
        sql10 = ("select value from[current] where [name] like 'D8.Dry.z1b_blw_di'")
        sql11 = ("select value from[current] where [name] like 'D8.Dry.z1bc_enable_di'")
        sql12 = ("select value from[current] where [name] like 'D8.Dry.z1c2_blw_di'")
        sql13 = ("select value from[current] where [name] like 'D8.Dry.casing_temp1_f_pv'")
        sql14 = ("select value from[current] where [name] like 'D8.Dry.casing_temp2_f_pv'")
        sql15 = ("select value from[current] where [name] like 'D8.Dry.casing_temp3_f_pv'")
        sql16 = ("select value from[current] where [name] like 'D8.Dry.casing_temp4_f_pv'")
        ...
        Try
            ...
            ' SqlReader = command.ExecuteReader()
            ' While SqlReader.Read()
            'TxtBelt_Speed.Text = (SqlReader.Item(0)) & "  FPM " '& SqlReader.Item(1) & "-" & SqlReader.Item(2))
            'End While
            ' SqlReader.Close()
            ...
            'SqlReader = command.ExecuteReader()
            'While SqlReader.Read()
            'TxtDryer_Speed.Text = (SqlReader.Item(0)) & "  FPM " ' & "-" & SqlReader.Item(1) & "-" & SqlReader.Item(2))
            ' End While
            ' SqlReader.Close()
            ...
            ' SqlReader = command.ExecuteReader()
            ' While SqlReader.Read()
            'txtCasing_Temp_7.Text = (SqlReader.Item(0)) & " - " & "Deg F" ' & "-" & SqlReader.Item(1) & "-" & SqlReader.Item(2))
            ' End While
            ' SqlReader.Close()
            ...
            SqlReader = command.ExecuteReader()
            While SqlReader.Read()
                txtCasing_temp1.Text = (SqlReader.Item(0)) & " - " & "Deg F" ' & "-" & SqlReader.Item(1) & "-" & SqlReader.Item(2))
            End While
            SqlReader.Close()
            ...
            SqlReader = command.ExecuteReader()
            While SqlReader.Read()
                txtCasing_temp2.Text = (SqlReader.Item(0)) & " - " & "Deg F" ' & "-" & SqlReader.Item(1) & "-" & SqlReader.Item(2))
            End While
            SqlReader.Close()
            ...
            SqlReader = command.ExecuteReader()
            While SqlReader.Read()
                txtCasing_temp3.Text = (SqlReader.Item(0)) & " - " & "Deg F" ' & "-" & SqlReader.Item(1) & "-" & SqlReader.Item(2))
            End While
            SqlReader.Close()
            ...
            SqlReader = command.ExecuteReader()
            While SqlReader.Read()
                txtCasing_temp4.Text = (SqlReader.Item(0)) & " - " & "Deg F" ' & "-" & SqlReader.Item(1) & "-" & SqlReader.Item(2))
            End While
            SqlReader.Close()
